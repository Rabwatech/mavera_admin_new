...
import { Search, RefreshCw, Download, CheckCircle, Clock, AlertTriangle, PlusCircle, CreditCard } from 'lucide-react';
...
const InvoicesPage: React.FC = () => {
  ...
  // Mock Data
  const invoices = [
    { id: 'INV-2024-001', client: 'Al-Rajhi Wedding', amount: 50000, due: '2024-10-25', status: 'Paid', method: 'Riyad Bank', erp: 'Synced' },
    { id: 'INV-2024-002', client: 'Golden Gala', amount: 15000, due: '2024-11-01', status: 'Unpaid', method: 'Pending', erp: 'Pending' },
    { id: 'INV-2024-003', client: 'Fahad & Sara', amount: 5000, due: '2024-10-20', status: 'Overdue', method: 'Pending', erp: 'Pending' },
    { id: 'DRAFT-004', client: 'Corp Event #44', amount: 2500, due: '-', status: 'Draft', method: '-', erp: '-' }, 
  ];
                  ...
                  {filteredInvoices.map(inv => (
                     <tr key={inv.id} className="hover:bg-gray-50 transition-colors group">
                        ...
                        <td className="px-6 py-4">
                           ...
                           {inv.status === 'Paid' && <span className="text-[10px] text-gray-400 block mt-1">via {inv.method}</span>}
                        </td>
                        <td className="px-6 py-4">
                           {inv.erp === 'Synced' ? (
